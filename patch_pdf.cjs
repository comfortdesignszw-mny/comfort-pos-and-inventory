...
const replacement = `export function generateReceiptPDF(sale: any, settings: any) {
  const doc = new jsPDF({
...
code = code.replace(/export function generateReceiptPDF\(sale: any, settings: any\) \{[\s\S]*\}\s*$/m, replacement);
